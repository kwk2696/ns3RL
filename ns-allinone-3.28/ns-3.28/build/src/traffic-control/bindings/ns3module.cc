...
PyObject *
PyNs3QueueDisc__PythonHelper::_wrap_PeekDequeued(PyNs3QueueDisc *self)
{
    PyObject *py_retval;
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method PeekDequeued of class QueueDisc is protected and can only be called by a subclass");
        return NULL;
    }
    retval = helper->PeekDequeued__parent_caller();
